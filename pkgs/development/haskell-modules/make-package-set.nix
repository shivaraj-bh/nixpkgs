...
let
  ...
  hackage2nix =
    name: version:
    self.hackage2nixWithOptions name version "";
...
// {
  ...
  callHackageWithOptions = name: version: extraCabal2nixOptions: callPackageKeepDeriver (self.hackage2nixWithOptions name version extraCabal2nixOptions);
